...
import { X, Plus, Edit2, Package, Check, Trash2, RotateCcw } from 'lucide-react';
          ...
          <div className="flex items-center gap-2">
            {onResetDefaults && (
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1 bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 border border-amber-500/30 rounded-lg text-xs font-semibold transition"
                title="Reload default sample products"
              >
                <RotateCcw className="w-3.5 h-3.5" />
                <span className="hidden sm:inline">Load Sample Products</span>
                <span className="sm:hidden">Sample Catalog</span>
              </button>
            )}
            <button
              onClick={onClose}
